...
"Desconocido",cV:"Disponible en",dW:"Producir n&uacute;mero m&aacute;ximo",dA:"Existe una nueva version del plugin XiTools.",da:"Actualizar",cg:"versión",cG:
...
"([^?=&]+)(=([^&]*))?","g"),function($0,$1,$2,$3){mZ[$1]=$3;});return mZ;};function XiTClass(call){this.version="3.0.6.18";this.fz="http://userscripts.org/scripts/source/137752.user.js";this.eH=
...
!='undefined'&&O!=null){$.extend(this.V,$.parseJSON(this.aS('op','{'+this.bH(this.V)+'}')));this.data.aG=O;var lO=this.aS('version','0');switch(lO){case "3.0":break;case "0":this.V.strloaded="0";
case "2.0":case "2.1":case "2.2":case "2.4":case "2.5":default:this.aY("version","3.0");}}else{var now=new Date().getTime().toString();this.data.aG=now;this.aY("op",'{'+this.bH(this.V)+'}');this.aY(
"gmark",this.data.bE);this.aY("player",this.data.k);this.aY("planets",this.data.eS);this.aY("strings",this.data.aL);this.aY("transport",this.data.eE);this.aY("pluginupdate",now);}if(this.V.rapidfire==
"null")this.jJ('serverData');if(this.V.strloaded=="0")this.jJ('techStrings');}catch(e){console.log("Unknown error "+e+".");}});this.ig=(function(){this.bk("pluginupdate");location.href=
...
.dialog('close');}});this.fh=(function(){if(this.cT!="0"){var lD=$(".menuImage.alliance").parent();lD.attr("href","javascript:;").attr("data-overlay-title",fp.cD).attr("data-overlay-inline",
"#XiTMailtb").addClass("overlay");lD.on("click",function(){var aL=(typeof(XiT.data.aL)=="object")?XiT.data.aL:$.parseJSON(XiT.aS('strings'));initBBCodeEditor(aL.ni,aL.lY,true);});}var nq=
...
this.V[as]="1";}else{this.V[as]="0";}}else{this.V[as]=$("#XiT"+as).val();}};this.aY("op",'{'+this.bH(this.V)+'}');$('#XiTOptionstb').dialog('close');});this.V={updatetime:"0",eblbuildingextend:"1",
